...
pub(crate) fn create_bad_debt_auction_data(e: &Env) -> TierAuctionData {
...
pub(crate) fn fill_bad_debt_auction(
    ...
    let auction = get_bad_debt_auction(e);
...
/// usable value.
pub(crate) fn default_backstop_bad_debt(e: &Env) {
    require_no_active_bad_debt_auction(e);
