...
/// Minimum bToken exchange rate at which a reserve may accept new risk.
/// Represents 0.1 at 12-decimal fixed-point precision.
pub const MIN_OPERATIONAL_B_RATE: i128 = 100_000_000_000;
